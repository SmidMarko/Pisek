...
return [
    ...
    'samlArnesLoginRedirect' => env('SAML2_ARNES_REDIRECT_LOGIN_URL'),
    'samlArnesLogoutRedirect' => env('SAML2_ARNES_REDIRECT_LOGOUT_URL'),
    'samlIdpDiscovery' => env('SAML2_IDP_DISCO'),
    'samlIdpDiscoveryReturn' => env('SAML2_IDP_DISCO_RETURN'),
    'samlIdpMetadata' => env('SAML2_IDP_METADATA'),
