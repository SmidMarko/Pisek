   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            west: "pojdi levo",
            north: "pojdi gor",
            paint: "pobarvaj", //zmajček
            pickTransportable: "poberi zrno", //pišek
            dropTransportable: "pospravi zrno", //pišek
            onTransportable: "na zrnu", //pišek
            ...
            addPlatformAbove: "postavi ploščad zgoraj",
            addPlatformInFront: "postavi ploščad spredaj",
            ...
            dir: "trenutna smer",
            col: "trenutni stolpec",
            row: "trenutna vrstica",
            alert: "opozorilo",
            onPill: "na bonbonu",
         ...
         messages: {
            ...
            alreadyTransporting: "Piščanček Pišek že nosi zrno.", //pišek
            notTransporting: "Piščanček Pišek skuša spustiti zrno, vendar ga ne nosi.", //pišek
            successDroppedAllObjects: "Čestitamo, piščanček Pišek je supstil vse predmete!", //pišek
            successMarkersPainted: "Čestitamo, zmajček je pravilno pobarval polja!", //zmajček
            failureMarkersPainted: "Zmajček ni pobarval pravih polj.", //zmajček
            successPickedAllCollectibles: "Čestitamo, piščanček Pišek je pobral vsa zrna!", //pišek
            failurePickedAllCollectibles: "Piščanček Pišek ni pobral vseh predmetov!", //pišek
            successReachGeenArea: "Čestitamo, robot je dosegel zeleno območje!",
            failureReachGeenArea: "Robot ni dosegel zelenega območja!",
            successOneMarbleInHole: "Čestitamo, zrno je v gnezdu!", //pišek
            successAllMarblesInHoles: "Čestitamo, vsa zrna so v gnezdu!", //pišek
            failureOneMarbleInHole: "Zrno ni v gnezdu!", //pišek
            failureAllMarblesInHoles: "Vsa zrna niso v gnezdih!", //pišek
            leavesGrid: "Piščanček Pišek je zapustil mrežo!"//pišek
         },
         description: {
            platformAbove: "ploščadZgoraj(): Ali obstaja ploščad zgoraj?",
            obstacleInFront: "oviraSpredaj(): Ali obstaja ovira spredaj?",
            onHole: "naLuknji(): Ali je Pišek na gnezdu?", //pišek
            onTransportable: "naPredmetu(): Ali je Pišek na zrnu?", //pišek
            onRoundObject: "naKrogu(): Ali smo na okroglem predmetu?",
            onSquareObject: "naKvadratu(): Ali smo na kvadratnem predmetu?",
            onTriangleObject: "naTrikotniku(): Ali smo na trikotnem predmetu?",
            onDottedObject: "naPikčastemPredmetu(): Ali smo na pikčastem predmetu?",
            onFullObject: "naPolnemPredmetu(): Ali smo na polnem predmetu?",
            onStripedObject: "naČrtastemPredmetu(): Ali smo na črtastem predmetu?",
            paintOnCell: "pobarvanoPolje(): Ali je polje pobarvano?", 
            gridEdgeInFront: "robMrežeSpredaj(): Ali je rob mreže spredaj?",
            gridEdgeEast: "robMrežeDesno(): Ali je rob mreže na desni?",
            gridEdgeWest: "robMrežeLevo(): Ali je rob mreže na levi?",
            gridEdgeAbove: "robMrežeZgoraj(): Ali je rob mreže zgoraj?",
            gridEdgeBelow: "robMrežeSpodaj(): Ali je rob mreže spodaj?",
            platformInFront: "ploščadSpredaj(): Ali obstaja ploščad spredaj?",
            numberUnder: "številkaPolja(): Številka na polju.",
            col: "stolpec(): Trenutni stolpec",
            row: "vrstica(): Trenutna vrstica",
            paintNorth: "pobarvanaZgoraj(): Ali je zgoraj pobarvano polje?",
            paintNorthWest: "pobarvanaZgorajLevo(): Ali je levo zgoraj pobarvano polje?",
            paintNorthEast: "pobarvanaZgorajDesno(): Ali je desno zgoraj pobarvano polje?",
            writeNumber: "zapišiŠtevilko(številka): Zapiši številko na trenutno polje."
         },
         obstacle: "Ovire se ne da premakniti!",
         startingBlockName: "Program",
         exit_grid: "Mreže ne morete zapustiti!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Piščanček Pišek že nosi zrno.", //pišek
         jumpOutsideGrid: "Iz mreže ne morete skočiti ven!",
         jumpObstacleBlocking: "Ovire se ne da preskočiti!",
         jumpNoPlatform: "Skočiti se da samo na ploščad!",
         downOutsideGrid: "Mreže ne morete zapustiti!",
         downNoPlatform: "Spodaj ni ploščadi!",
         falls: "Padec v praznino!",
         willFallAndCrash: "Padec iz ploščadi je nevaren!",
         dropWithoutItem: "Piščanček Pišek skuša spustiti zrno, vendar ga ne nosi.", //pišek
