	...
	var localLanguageStrings = {
		sl: {
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Ni lešnikov, ki bi jih lahko pobral.",
				nothingToPickUp2: "Ni lešnikov, ki bi jih lahko pobral.",
				...
				failurePickedAllWithdrawables: "Čebelica še ni zadovoljna. Poduhati mora vse roze!",
				...
				jumpOutsideGrid: "Čebelica skuša odleteti izven mreže!",
				jumpObstacleBlocking: "Čebelica skuša leteti, vendar zaradi ovire ne more!",
				jumpNoPlatform: "Čebelica skuša leteti, vendar ni nobene ploščadi!",
				downOutsideGrid: "Čebelica se skuša premakniti izven mreže!",
				downNoPlatform: "Čebelica se skuša premakniti dol, vendar spodaj ni ploščadi!",
				falls: "Čebelica pada.",
				willFallAndCrash: "Čebelica je zapusila mrežo.",
				obstacleOnCell: "Na tem polju je ovira.",
				platformOnCell: "Na tem polju je že ploščad.",
				obstacle: "Ojoj! Čebelica se je zaletela v oviro. Poskusi še enkrat.",
			},
		},
		none: {
			comment: {
