	...
	var localLanguageStrings = {
		...
		sl: {
			...
			messages: {								//Besedila sporočil
				...
				successMarkersPainted: "Čestitamo, Izabela je pravilno položila med  v satovje!",
				failureMarkersPainted: "Izabela ni pravilno položila medu v satovje.",
				...
				leavesGrid: "Čebelica je zapustila mrežo!",
