	...
	var localLanguageStrings = {
		...
		sl: {
			...
			label: {									//Imena ukazov
				...
				paint: "postavi oviro",
				pickTransportable: "poberi skrinjo",
				dropTransportable: "odloži skrinjo",
				onTransportable: "na polju s skrinjo",
			...
			code: {
				...
				obstacleEast: "ovira_desno",
				obstacleWest: "ovira_levo",
			...
			description: {								//Opis ukazov
				wait: "počakaj",
				right: "obrni se v smeri urinega kazalca",
				left: "obrni se v nasprotni smeri urinega kazalca",
				turnAround: "obrni se za 180°",
				jump: "skok",
				down: "skok dol",
				forward: "naprej",
				east: "desno",
				...
				onTransportable: "na polju z zakladom",
				onRoundObject: "na polju z zakladom",
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Ni več skrinje, ki bi jo lahko pobral.",
				alreadyTransporting: "Zmajček že nosi skrinjo.",
				notTransporting: "Zmajček skuša odložiti skrinjo, vendar je ne nosi.",
				successDroppedAllObjects: "Čestitamo, zmajček je skril vse skrinje!",
				successMarkersPainted: "Čestitamo, zmajček je pravilno postavil ovire!",
				failureMarkersPainted: "Zmajček ni postavil ovir na pravo polje.",
				successPickedAllCollectibles: "Čestitamo, zmajček je pobral ves zaklad!",
				failurePickedAllCollectibles: "Zmajček ni pobral vsega zaklada!",
				successReachGeenArea: "Super! Zmajček je dosegel cilj.",
				failureReachGeenArea: "Ojoj! Zmajček ni prispel do cilja. Poskusi še enkrat.",
				successOneMarbleInHole: "Čestitamo, skrinja je na varnem!",
				successAllMarblesInHoles: "Čestitamo, vse skrinje so na varnem!",
				failureOneMarbleInHole: "Ena skrinja zlatnikov ni na pravem mestu!",
				failureAllMarblesInHoles: "Vsaka skrinja ni v svojem gradu!",
				...
				willFallAndCrash: "Zmajček bo padel s ploščadi in se poškodoval!",
				obstacleOnCell: "Na tem polju je ovira.",
				platformOnCell: "Na tem polju je že ploščad.",
				obstacle: "Ojoj! Zmajček se je zaletel v oviro. Poskusi še enkrat.",
			},
		},
		none: {
			comment: {
