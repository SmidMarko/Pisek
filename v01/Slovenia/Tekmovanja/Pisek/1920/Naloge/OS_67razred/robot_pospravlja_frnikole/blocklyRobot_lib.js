	...
	var localLanguageStrings = {
		...
		sl: {
			...
			label: {									//Imena ukazov
				...
				dropTransportable: "pospravi frnikolo",
			...
			messages: {								//Besedila sporočil
				...
				successOneMarbleInHole: "Čestitamo, frnikola je na pravem mestu!",
				successAllMarblesInHoles: "Čestitamo, vse frnikole so na pravih mestih!",
				failureOneMarbleInHole: "Frnikola ni v odložišču!",
				failureAllMarblesInHoles: "Vse frnikole niso v odložiščih!",
