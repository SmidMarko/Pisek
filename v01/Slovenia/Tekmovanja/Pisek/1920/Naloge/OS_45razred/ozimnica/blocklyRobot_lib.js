	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				pickWithdrawable: "poberi lešnik",
				onWithdrawable: "na lešniku",
			...
			messages: {								//Besedila sporočil
				...
				successPickedAllWithdrawables: "Čestitamo, veveriček je pobral vse lešnike!",
				failurePickedAllWithdrawables: "Veveriček ni pobral vseh lešnikov!",
				...
				leavesGrid: "Veveriček je zapustil mrežo!",
				...
				obstacle: "Ojoj! Veverica se je zaletela v oviro. Poskusi še enkrat.",
			},
		},
		none: {
			comment: {
