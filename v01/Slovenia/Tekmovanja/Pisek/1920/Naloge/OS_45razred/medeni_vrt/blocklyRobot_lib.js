	...
	var localLanguageStrings = {
		sl: {
			...
			messages: {								//Besedila sporočil
				...
				alreadyTransporting: "Čebelica že nosi.",
				notTransporting: "Čebelica skuša odloži, vendar nič ne nosi.",
				successDroppedAllObjects: "Čestitamo, čebelica je vse odložila!",
				...
				successOneMarbleInHole: "Čestitamo, vsaj en sat je napolnjen!",
				successAllMarblesInHoles: "Čestitamo, čebelica je napolnila vse sate!",
				failureOneMarbleInHole: "Cvetni prah ene cvetlice ni v svojem satu!",
				failureAllMarblesInHoles: "Cvetni prah vseh cvetlic ni v satu!",
				leavesGrid: "Čebelica je zapustila mrežo!",
				jumpOutsideGrid: "Čebelica skuša skočiti izven mreže!",
