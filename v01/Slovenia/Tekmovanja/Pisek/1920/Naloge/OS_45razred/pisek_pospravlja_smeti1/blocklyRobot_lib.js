	...
	var localLanguageStrings = {
		...
		sl: {
			...
			label: {									//Imena ukazov
				...
				paint: "postavi oviro",
				pickTransportable: "poberi plastenko",
				dropTransportable: "pospravi plastenko",
				onTransportable: "pri plastenki",
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Na polju ni plastenk, ki bi jih lahko pobral.",
				alreadyTransporting: "Pišek že nosi plastenko.",
				notTransporting: "Pišek skuša spustiti predmet, vendar ga ne nosi.",
				successDroppedAllObjects: "Čestitamo, pišek je pospravil vse plastenke!",
				...
				successPickedAllCollectibles: "Čestitamo, pišek je posšravil vse plastenke!",
				failurePickedAllCollectibles: "Pišek ni pobral vseh predmetov!",
				successReachGeenArea: "Super! Pišek je dosegel cilj.",
				failureReachGeenArea: "Ojoj! Pišek ni prispel do cilja. Poskusi še enkrat.",
				successOneMarbleInHole: "Čestitamo, plastenka je v košu!",
				successAllMarblesInHoles: "Čestitamo, vse plastenke so v košu!",
				failureOneMarbleInHole: "Plastenka ni v košu!",
				failureAllMarblesInHoles: "Vse plastenke niso v košu!",
				...
				willFallAndCrash: "Pišek bo padel s ploščadi in se poškodoval!",
