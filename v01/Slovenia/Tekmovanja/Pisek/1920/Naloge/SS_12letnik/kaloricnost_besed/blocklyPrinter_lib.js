...
var getContext = function(display, infos) {
	var localLanguageStrings = {
		...
		sl: {
			...
			label: {										//Imena ukazov
				...
				checkSubstring: "v besedilu %1 je besedilo %2",
			},
			code: {
				print: "napisi",
				print_end: "napisi",
	...
	//CUSTOM
	context.printer.checkSubstring = function(string1, string2, callback) {
		var bool = true;
		if(string1.indexOf(string2) == -1) bool = false;
		context.waitDelay(callback, bool);
	}
	...
	context.customBlocks = {
		printer: {
			...
			texts:[
				{ name: "checkSubstring", yieldsValue: true, blocklyJson: {"args0": [{"type": "input_value", "name": "PARAM_0"}, {"type": "input_value", "name": "PARAM_1"}]}},
			],
		}
	}
