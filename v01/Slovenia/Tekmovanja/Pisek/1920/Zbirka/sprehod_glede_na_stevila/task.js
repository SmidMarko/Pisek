function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		includeBlocks: {						//dovoljeni ukazi 
			...
			generatedBlocks: {
				robot: ["forward","left","right","numberUnder"],
			},
			standardBlocks: {
				includeAll: false,
				wholeCategories: ["variables","logic"],
		...
		itemTypes: {
			...
			paint2: { num: 9, img: "paint2.png", side: 60, category: "paint", isPaint: true, zOrder: 4 },
			paint3: { num: 10, img: "paint3.png", side: 60, category: "paint", isPaint: true, zOrder: 4 },
			8: { num: 108, side: 60, category: "number", value: 8 },
			10: { num: 110, side: 60, category: "number", value: 10 },
			15: { num: 115, side: 60, category: "number", value: 15 },
			16: { num: 116, side: 60, category: "number", value: 16 },
			23: { num: 123, side: 60, category: "number", value: 23 },
