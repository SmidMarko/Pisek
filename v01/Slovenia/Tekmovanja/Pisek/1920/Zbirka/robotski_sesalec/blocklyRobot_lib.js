	...
	var localLanguageStrings = {
		sl: {
			...
			messages: {								//Besedila sporočil
				...
				successReachGeenArea: "Super! Sesalec je prispel do vtičnice.",
				failureReachGeenArea: "Ojoj! Sesalec ni prispel do vtičnice. Poskusi še enkrat.",
				...
				leavesGrid: "Sesalec je zapustil mrežo!",
				...
				obstacle: "Ojoj! Sesalec se je zaletel v oviro. Poskusi še enkrat.",
			},
		},
		none: {
			comment: {
