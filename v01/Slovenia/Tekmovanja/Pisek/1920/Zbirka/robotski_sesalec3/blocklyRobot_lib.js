	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				pickWithdrawable: "posesaj smeti",
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Ni smeti, ki bi jih lahko posesal.",
				nothingToPickUp2: "Ni smeti, ki bi jih lahko posesal.",
				...
				successPickedAllCollectibles: "Čestitamo, robot je posesal vse smeti!",
				failurePickedAllCollectibles: "Robot ni posesal vseh smeti!",
				successPickedAllWithdrawables: "Čestitamo, robotski sesalec je posesal vse smeti!",
				failurePickedAllWithdrawables: "Robotski sesalec ni posesal vseh smeti!",
