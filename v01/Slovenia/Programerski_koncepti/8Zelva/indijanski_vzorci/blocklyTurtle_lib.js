   ...
   var localLanguageStrings = {
	  ...
	  sl: {
         ...
         code: {
            ...
            penup: "dvigniPisalo",
            pendown: "izpustiPisalo",
            peneither: "pisalo",
            colour2: "nastaviBarvo",
            colourvalue: "barva",
            turn: "zavij",
            alert: "alert",
            log: "dnevnik",
         ...
         messages: {
            paintingWrong: "Želva ni naslikala pravega vzorca.",
            paintingCorrect: "Čestitamo! Želva je naslikala pravi vzorec.",
            paintingFree: "Želva je naslikala vzorec, ki si ga sprogramiral. Če ga želiš shraniti, posnemi sliko zaslona."
         }
      },
      none: {
         comment: {
