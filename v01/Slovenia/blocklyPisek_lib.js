    ...
    var localLanguageStrings = {
        ...
        sl: {
            ...
            messages: {
                ...
                alreadyTransporting: "Robotek že nosi predmet.",
                notTransporting: "Robotek skuša spustiti predmet, vendar ga ne nosi.",
                successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
                successMarkersPainted: "Čestitamo, robotek je pravilno pobarval polja!",
                failureMarkersPainted: "Robotek ni pobarval pravega polja.",
                successPickedAllCollectibles: "Super! Robotek je našel vse dele v bližini. Pojdi raziskat naslednje območje.",
                failurePickedAllCollectibles: "Ojoj! Robotku ni uspelo pobrati vseh delov. Poskusi še enkrat.",
                successReachGeenArea: "Super! Robotek je pobegnil v naslednjo sobo.",
                failureReachGeenArea: "Ojoj! Robotku ni uspelo priti do naslednje sobe. Poskusi še enkrat.",
                ...
                leavesGrid: "Robotek je zapustil mrežo!",
            ...
            description: {
                ...
                onHole: "naLuknji(): Ali je robotek na luknji?",
                onTransportable: "naPredmetu(): Ali je robotek na predmetu, ki ga lahko pobere?",
                onRoundObject: "naKrogu(): Ali je robotek na okroglem predmetu?",
                onSquareObject: "naKvadratu(): Ali je robotek na kvadratnem predmetu?",
                onTriangleObject: "naTrikotniku(): Ali je robotek na trikotnem predmetu?",
                onDottedObject: "naPikčastemPredmetu(): Ali je robotek na pikčastem predmetu?",
                onFullObject: "naPolnemPredmetu(): Ali je robotek na polnem predmetu?",
                onStripedObject: "naČrtastemPredmetu(): Ali je robotek na črtastem predmetu?",
                paintOnCell: "pobarvanoPolje(): Ali je polje, na katerem je robotek, pobarvano?",
                ...
                numberUnder: "številkaPolja(): Številka polja, na katerem je robotek.",
                col: "stolpec(): Stolpec na katerem je robotek",
                row: "vrstica(): Vrstica na kateri je robotek",
                paintNorth: "pobarvanaZgoraj(): Ali je pobarvano polje nad poljem, na katerem je robotek?",
                paintNorthWest: "pobarvanaZgorajLevo(): Ali je pobarvano polje levo nad poljem, na katerem je robotek?",
                paintNorthEast: "pobarvanaZgorajDesno(): Ali je pobarvano polje desno nad poljem, na katerem je robotek?",
                writeNumber: "zapišiŠtevilko(številka): Zapiše številko v polje, na katerem je robotek."
            },
            obstacle: "Robotek se je zaletel v oviro!",
            startingBlockName: "Program",
            exit_grid: "Robotek je zapustil mrežo!",
            nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
            alreadyTransportingObject: "Robotek že nosi predmet.",
            jumpOutsideGrid: "Robotek skuša skočiti izven mreže!",
            jumpObstacleBlocking: "Robotek skuša skočiti, vendar zaradi ovire ne more!",
            jumpNoPlatform: "Robotek skuša skočiti, vendar ni nobene ploščadi!",
            downOutsideGrid: "Robotek se skuša premakniti izven mreže!",
            downNoPlatform: "Robotek se skuša premakniti dol, vendar spodaj ni ploščadi!",
            falls: "Robotek pada v prazno.",
            willFallAndCrash: "Robotek bo padel z ploščadi in se poškodoval!",
            dropWithoutItem: "Robotek skuša spustiti predmet, vendar ga ne nosi.",
            ...
            itemObserved: "Robot je že preučil predmet X.",
            turnToItemString: "Obrni robota v smer: %1"
        },
        none: {
            comment: {}
        }
