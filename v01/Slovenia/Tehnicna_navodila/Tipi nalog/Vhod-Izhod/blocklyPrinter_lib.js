...
var getContext = function(display, infos) {
   var localLanguageStrings = {
	  ...
	  sl: {
         label: {
            print: "izpiši",
            print_end: "izpiši %1 s končnico %2",
         ...
         messages: {
            ...
            outputWrong: "Ojoj! Govor ni pravilno popravljen.",
            outputCorrect: "Čestitke! Govor je pravilno zapisan.",
            tooFewChars: "Ojoj! Govor nima dovolj vrstic.",
            tooManyChars: "Ojoj! Govor ima preveč vrstic.",
            tooFewLines: "Premalo vrstic na izhodu",
            tooManyLines: "Preveč vrstic na izhodu",
            correctOutput: "Čestitke! Govor je pravilno zapisan.",
            moreThan100Moves: "Bravo! Govor je pravilno popravljen, a za nalogo si uporabil več kot 100 potez. Poskusi še enkrat."
         },
         errorStr: {
            intro: "Izhod tvojega programa je napačen v vrstici ",
            expected: " :<br>Pričakovano: \"<b>",
            answer: "</b>\",<br>Vaš odgovor: \"<b>",
            introChar: "</b>\".<br>(Prvi znak je napačen v stolpcu ",
            expectedChar: "; pričakovano: \"<b>",
            answerChar: "</b>\", vaš odgovor: \"<b>"
         }
      },
      none: {
         comment: {
      ...
      for (iLine = 0; iLine < expectedLines.length && iLine < actualLines.length; iLine++) {
         ...
         for (iChar = 0; iChar < expectedLine.length && iChar < actualLine.length; iChar++) {
            if (actualLine[iChar] != expectedLine[iChar]) {
               this.success = false;
               var errorstring = "Izhod tvojega programa je napačen v vrstici " +                                       (iLine + 1) + " :<br>Pričakovano: \"<b>" +                                       escapeHtml(expectedLine) + "</b>\",<br>Vaš odgovor: \"<b>" +                                  escapeHtml(actualLine) + "</b>\".<br>(Prvi znak je napačen v stolpcu " +                                       (iChar + 1) + "; pričakovano: \"<b>" +                                       escapeHtml(expectedLine[iChar]) + "</b>\", vaš odgovor: \"<b>" +                                  escapeHtml(actualLine[iChar]) + "</b>\".)"
