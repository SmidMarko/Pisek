function initTask(subTask) {
   ...
   subTask.gridInfos = {
      ...
      itemTypes: {
		 ...
		 obstacle: { num: 21, img: "obstacle.png", side: cellSide, isObstacle: false, zOrder: 0 },
      ...
      checkEndCondition: function(context, lastTurn) {
         if (lastTurn) {
                  ...
                  if (hasNumber) {
                     ...
                     if (oldNumber != 100) {
                        ...
                        if (total != itemType.value) {
                           context.success = false;
                           throw("Ojoj! Robotku ni uspelo vpisati skrivnega gesla. Poskusi še enkrat.");
                        }
                     }
                  }
               }
            ...
            throw("Super! Robotek je vpisal pravo skrivno geslo. Nadaljuj v naslednji sobi!");
         }
      }
   };
