function initTask(subTask) {
   ...
   subTask.gridInfos = {
      ...
      itemTypes: {
         ...
         pisek_robot: { img: "pisek.png", side: 80, nbStates: 9, isObstacle: true, offsetX: -14, category: "robot", team: 0, zOrder: 2 },
      ...
      includeBlocks: {
          ...
          generatedBlocks: {
              robot: {
                  easy: ["east", "north", "south", "west", "itemObserve", "onObservableItem", "changeRobot"],
        ...
        easy: [
            {
                ...
                initItems: [
                    { row: 1, col: 3, dir: 0, type: "pisek_robot" },
