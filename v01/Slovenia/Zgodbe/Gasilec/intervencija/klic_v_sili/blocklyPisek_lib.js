   ...
   var localLanguageStrings = {
      ...
      sl: {
         ...
         messages: {
            ...
            successMarkersPainted: "Čestitamo, Gasilka je pravilno postavila gnezda!",
            failureMarkersPainted: "Gasilka ni postavila gnezda na pravo polje.",
            successPickedAllCollectibles: "Čestitamo, Gasilka je pobrala vse predmete!",
            failurePickedAllCollectibles: "Gasilka ni pobrala vseh predmetov!",
            successReachGeenArea: "Super! Gasilka je prišela do kraja požara.",
            failureReachGeenArea: "Ojoj! Gasilka ni prispela do požara. Poskusi še enkarat.",
            ...
            leavesGrid: "Gasilka je zapustila mrežo!"
         },
         description: {
         ...
         obstacle: "Ojoj! Gasilka se je zaletela v drevo. Poskusi še enkrat.",
         startingBlockName: "Program",
         exit_grid: "Gasilka je zapustila mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         ...
         willFallAndCrash: "Gasilka bo padla s ploščadi in se poškodovala!",
