   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            pickTransportable: "poberi cev",
            dropTransportable: "pospravi cev",
         ...
         messages: {
            ...
            successPickedAllCollectibles: "Čestitamo, Gasilka je pobral vse predmete!",
            ...
            successOneMarbleInHole: "Čestitamo, cev je v gnezdu!",
            successAllMarblesInHoles: "Čestitamo, vse cevi so na mestu!",
            failureOneMarbleInHole: "cev ni v gnezdu!",
            failureAllMarblesInHoles: "Vse cevi niso na pravem mestu!",
            leavesGrid: "Gasilka je zapustil mrežo!"
         },
         description: {
         ...
         obstacle: "Ojoj! Gasilka se je zaletel v drevo. Poskusi še enkrat.",
         startingBlockName: "Program",
         exit_grid: "Gasilka je zapustil mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
