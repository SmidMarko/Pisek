   ...
   var localLanguageStrings = {
      ...
      sl: {
         ...
         messages: {
            ...
            failureMarkersPainted: "Robot ni postavil ovire na pravo polje.",
            ...
            successReachGeenArea: "Čestitke! Kapitan je uspešno priplul do zaklada.",
            failureReachGeenArea: "Ladji ni uspelo pripluti do zaklada.",
            successOneMarbleInHole: "Čestitamo, paket je na pravem mestu!",
            successAllMarblesInHoles: "Čestitamo, vsa paketi so na pravih mestih!",
            failureOneMarbleInHole: "Paket ni v odložišču!",
            failureAllMarblesInHoles: "Vsa paketi niso v odložiščih!",
         ...
         startingBlockName: "Program",
         exit_grid: "Ladja je zapustila mrežo.",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
