	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				pickTransportable: "poberi jajce",
				dropTransportable: "odloži jajce",
			...
			messages: {								//Besedila sporočil
				...
				failurePickedAllCollectibles: "Pišek ni pobral vseh zrn!",
				successReachGeenArea: "Super! Robot je dosegel cilj.",
				failureReachGeenArea: "Ojoj! Robot ni prispel do cilja. Poskusi še enkrat.",
				successOneMarbleInHole: "Čestitamo, Pišek je pospravil jajce v gnezdo!",
				successAllMarblesInHoles: "Čestitamo, Pišek je pospravil vsa jajca v gnezda!",
				failureOneMarbleInHole: "Jajce ni v gnezdu!",
				failureAllMarblesInHoles: "Vsa jajca niso v gnezdih!",
