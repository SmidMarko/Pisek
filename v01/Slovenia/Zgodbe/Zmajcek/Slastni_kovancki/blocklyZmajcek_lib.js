   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            pickTransportable: "poberi dragulj",
            dropTransportable: "pospravi dragulj",
            onTransportable: "na dragulju",
         ...
         messages: {
            ...
            alreadyTransporting: "Zmajček že nosi predmet.",
            notTransporting: "Zmajček skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, zmajček je spustil vse predmete!",
            ...
            successPickedAllCollectibles: "Zmajček je pojedel vse kovančke in veselo rignil.",
            failurePickedAllCollectibles: "Zmajček ni pojedel vseh kovančkov!",
            successReachGeenArea: "Čestitamo, zmajček je dosegel zeleno območje!",
            failureReachGeenArea: "Zmajček ni dosegel zelenega območja!",
            successOneMarbleInHole: "Čestitamo, dragulj je v skrinji!",
            successAllMarblesInHoles: "Čestitamo, vsi dragulji so v skrinjah!",
            failureOneMarbleInHole: "Dragulj ni v skrinji!",
            failureAllMarblesInHoles: "Vsi dragulji niso v skrinjah!",
            leavesGrid: "Zmajček je zapustil mrežo!"
         },
         description: {
            platformAbove: "ploščadZgoraj(): Ali obstaja ploščad nad zmajčkom?",
            obstacleInFront: "oviraSpredaj(): Ali obstaja ovira pred zmajčkom?",
            onHole: "naLuknji(): Ali je zmajček na gnezdu?",
            onTransportable: "naPredmetu(): Ali je zmajček na predmetu, ki ga lahko pobere?",
            onRoundObject: "naKrogu(): Ali je zmajček na okroglem predmetu?",
            onSquareObject: "naKvadratu(): Ali je zmajček na kvadratnem predmetu?",
            onTriangleObject: "naTrikotniku(): Ali je zmajček na trikotnem predmetu?",
            onDottedObject: "naPikčastemPredmetu(): Ali je zmajček na pikčastem predmetu?",
            onFullObject: "naPolnemPredmetu(): Ali je zmajček na polnem predmetu?",
            onStripedObject: "naČrtastemPredmetu(): Ali je zmajček na črtastem predmetu?",
            paintOnCell: "pobarvanoPolje(): Ali je polje, na katerem je zmajček, pobarvano?",
            gridEdgeInFront: "robMrežeSpredaj(): Ali je rob mreže pred zmajčkom?",
            gridEdgeEast: "robMrežeDesno(): Ali je rob mreže desno od zmajčka?",
            gridEdgeWest: "robMrežeLevo(): Ali je rob mreže levo od zmajčka?",
            gridEdgeAbove: "robMrežeZgoraj(): Ali je rob mreže nad zmajčkom?",
            gridEdgeBelow: "robMrežeSpodaj(): Ali je rob mreže pod zmajčkom?",
            platformInFront: "ploščadSpredaj(): Ali obstaja ploščad pred zmajčkom?",
            numberUnder: "številkaPolja(): Številka polja, na katerem je zmajček.",
            col: "stolpec(): Stolpec na katerem je zmajček",
            row: "vrstica(): Vrstica na kateri je zmajček",
            paintNorth: "pobarvanaZgoraj(): Ali je pobarvano polje nad poljem, na katerem je zmajček?",
            paintNorthWest: "pobarvanaZgorajLevo(): Ali je pobarvano polje levo nad poljem, na katerem je zmajček?",
            paintNorthEast: "pobarvanaZgorajDesno(): Ali je pobarvano polje desno nad poljem, na katerem je zmajček?",
            writeNumber: "zapišiŠtevilko(številka): Zapiše številko v polje, na katerem je zmajček."
         },
         obstacle: "Zmajček poskuša premakniti oviro!",
         startingBlockName: "Program",
         exit_grid: "Zmajček je zapustil mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Zmajček že nosi predmet.",
         jumpOutsideGrid: "Zmajček skuša skočiti izven mreže!",
         jumpObstacleBlocking: "Zmajček skuša skočiti, vendar zaradi ovire ne more!",
         jumpNoPlatform: "Zmajček skuša skočiti, vendar ni nobene ploščadi!",
         downOutsideGrid: "Zmajček se skuša premakniti izven mreže!",
         downNoPlatform: "Zmajček se skuša premakniti dol, vendar spodaj ni ploščadi!",
         falls: "Zmajček pada v prazno.",
         willFallAndCrash: "Zmajček bo padel z ploščadi in se poškodoval!",
         dropWithoutItem: "Zmajček skuša spustiti predmet, vendar ga ne nosi.",
