   ...
   var localLanguageStrings = {
      ...
      sl: {
         ...
         messages: {
            ...
            alreadyTransporting: "Eva že nosi predmet.",
            notTransporting: "Eva skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
            successMarkersPainted: "Čestitamo, Eva je pravilno postavil gnezda!",
            failureMarkersPainted: "Eva ni postavila gnezda na pravo polje.",
            successPickedAllCollectibles: "Čestitamo, Eva je pobrala vso hrano!",
            failurePickedAllCollectibles: "Eva ni pobrala zrn!",
            successReachGeenArea: "Čestitamo, Eva je dosegla zeleno območje!",
            ...
            failureAllMarblesInHoles: "Vsa hrana niso v gnezdu!",
            leavesGrid: "Eva je zapustila mrežo!"
         },
         description: {
         ...
         startingBlockName: "Program",
         exit_grid: "Eva je zapustila mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Eva že nosi predmet.",
