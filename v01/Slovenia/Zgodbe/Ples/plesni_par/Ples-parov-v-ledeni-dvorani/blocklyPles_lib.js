var getContext = function(display, infos, curLevel) {
    var localLanguageStrings = {
        ...
        sl: {
            label: {
                ...
                pickTransportable: "dvigni plesalko",
                dropTransportable: "odloži plesalko",
                pickFigure1: "dvigni plesalko",
                dropFigure1: "odloži plesalko",
                pickFigure2: "dvigni plesalca",
                dropFigure2: "odloži plesalca",
                onFigure1: "plesalka na polju",
                onFigure2: "plesalec na polju",
                transportingFigure: "nosi plesalko ali plesalca",
                changeFigure1: "zamenjaj plesalko",
                changeFigure2: "zamenjaj plesalca",
                ...
                danceMove: "naredi pirueto",
                danceJump: "naredi skok",
                ...
                redCell: "polje je rdeče",
                blueCell: "polje je modro",
                orangeCell: "polje je oranžno",
                yellowCell: "polje je rumeno",
                ...
                dir: "smer plesalke",
                col: "stolpec plesalke",
                row: "vrstica plesalke",
                alert: "opozorilo",
                onPill: "na bonbonu",
            ...
            code: {
                ...
                pickFigure1: "dvigniPlesalko",
                dropFigure1: "odložiPlesalko",
                pickFigure2: "dvigniPlesalca",
                dropFigure2: "odložiPlesalca",
                onFigure1: "naPlesalki",
                onFigure2: "naPlesalcu",
                transportingFigure: "nosiPlesalkoAliPlesalca",
                changeFigure1: "zamenjajPlesalko",
                changeFigure2: "zamenjajPlesalca",
                ...
                danceMove: "narediPirueto",
                danceJump: "narediSkok",
                ...
                redCell: "rdečePolje",
                blueCell: "modroPolje",
                orangeCell: "oranžnoPolje",
                yellowCell: "rumenoPolje",
            ...
            messages: {
                nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.", // TODO: remove
                alreadyTransporting: "Plesalka že nosi predmet.", // TODO: remove
                notTransporting: "Plesalka skuša spustiti predmet, vendar ga ne nosi.", // TODO: remove
                successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!", // TODO: remove
                successMarkersPainted: "Čestitamo, piščanček Pišček je pravilno postavil gnezda!", // TODO: remove
                failureMarkersPainted: "Piščanček Pišček ni postavil gnezda na pravo polje.", // TODO: remove
                successPickedAllCollectibles: "Čestitamo, piščanček Pišček je pobral vse predmete!", // TODO: remove
                failurePickedAllCollectibles: "Piščanček Pišček ni pobral vseh predmetov!", // TODO: remove
                successReachGeenArea: "Čestitke! Plesalka je priplesala do rumenega polja!",
                failureReachGeenArea: "Plesalka ni priplesala do rumenega polja.",
                successOneMarbleInHole: "Čestitamo, zrno je v gnezdu!", // TODO: remove
                successAllMarblesInHoles: "Čestitamo, vsa zrna so v gnezdu!", // TODO: remove
                failureOneMarbleInHole: "Zrno ni v gnezdu!", // TODO: remove
                failureAllMarblesInHoles: "Vsa zrna niso v gnezdu!", // TODO: remove
                leavesGrid: "Plesalka je zapustila dvorano!",
                successDance: "Čestitke! Koreografija je končana.",
                failureDance: "Ojoj! Koreografija ni končana. Poskusi še enkrat.",
                failureDanceMoves: "Plesalka ni naredila piruete.",
                failureDanceJumps: "Plesalka ni naredila piruete ali skoka.",
                PickUpSelf: "Plesalka ne more dvigniti sebe.",
                PickUpSelf2: "Plesalec ne more dvigniti sebe.",
                noFigure1: "Plesalke ni na polju.",
                noFigure2: "Plesalca ni na polju.",
            },
            description: {
            ...
            obstacle: "Plesalka poskuša premakniti oviro!",
            startingBlockName: "Program",
            exit_grid: "Piščanček Pišček je zapustil mrežo!",
            nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
            alreadyTransportingObject: "Plesalka že nosi predmet.",
            jumpOutsideGrid: "Plesalka skuša skočiti izven mreže!",
            jumpObstacleBlocking: "Plesalka skuša skočiti, vendar zaradi ovire ne more!",
            jumpNoPlatform: "Plesalka skuša skočiti, vendar ni nobene ploščadi!",
            downOutsideGrid: "Plesalka se skuša premakniti izven mreže!",
            downNoPlatform: "Plesalka se skuša premakniti dol, vendar spodaj ni ploščadi!",
            falls: "Plesalka pada v prazno.",
            willFallAndCrash: "Plesalka bo padla s ploščadi in se poškodovala!",
            dropWithoutItem: "Plesalka skuša spustiti predmet, vendar ga ne nosi.",
            ...
            noRedCell: " ni na rdečem polju.",
            noBlueCell: " ni na modrem polju.",
            ImpossibleToDance1: "Ojoj!",
            ImpossibleToDance2: " ne more narediti piruete, medtem ko nosi",
            ImpossibleToDanceJump2: " ne more narediti skoka, medtem ko nosi",
            alreadyTransportingFigure1: "Plesalec skuša dvigniti plesalko, vendar že nosi plesalko.",
            alreadyTransportingFigure2: "Plesalka skuša dvigniti plesalca, vendar že nosi plesalca.",
            turnToItemString: "Obrni figuro v smer: %1",
            changeRobotString: "Zamenjaj figuro: %1",
            noRobot: "Figure ni na mreži.",
        },
        none: {
            comment: {}
        }
    ...
    context.robot.forward = function (callback) {
        ...
        var item = context.getRobotItem(context.currentRobot);
        ...
        if (infos.hasGravity) {
            ...
            context.nbMoves++;
            moveRobot(context.currentRobot, coords.row, coords.col, item.dir, callback);
        }
    };
    ...
    context.robot.jump = function (callback) {
        ...
        context.nbMoves++;
        moveRobot(context.currentRobot, item.row - 2, item.col, item.dir, callback);
    };
    ...
    context.robot.turnAround = function (callback) {
        ...
        var item = context.getRobotItem(context.currentRobot);
        var newDir = (item.dir + 1) % 4;
        moveRobot(context.currentRobot, item.row, item.col, newDir, callback);
    };

    context.robot.platformInFront = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var col = robot.col;
        if (robot.dir == 0) {
            col += 1;
        } else {
    ...
    function createItem(newItem) {
        ...
        if ((infos.actionDelay > 0) && (context.display)) {
            context.delayFactory.createTimeout("addItem" + context.currentRobot + "_" + Math.random(), function () {
                addItem();
            }, infos.actionDelay / 2);
        } else {
            addItem();
    ...
    context.robot.east = function (callback) {
        ...
        if (!checkTileAllowed(item.row, item.col + 1)) {
            ...
            context.nbMoves++;
            moveRobot(context.currentRobot, item.row, item.col + 1, 0, callback);
        }
    };
    ...
    context.robot.west = function (callback) {
        ...
        if (!checkTileAllowed(item.row, item.col - 1)) {
            ...
            context.nbMoves++;
            moveRobot(context.currentRobot, item.row, item.col - 1, 2, callback);
        }
    };
    ...
    context.robot.north = function (callback) {
        ...
        if (!checkTileAllowed(item.row - 1, item.col)) {
            ...
            context.nbMoves++;
            moveRobot(context.currentRobot, item.row - 1, item.col, 3, callback);
        }
    };
    ...
    context.robot.south = function (callback) {
        ...
        if (!checkTileAllowed(item.row + 1, item.col)) {
            ...
            context.nbMoves++;
            moveRobot(context.currentRobot, item.row + 1, item.col, 1, callback);
        }
    };
    ...
    // Blocks for pisek.acm.si


    context.robot.onFigure1 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var figures = context.getItems(robot.row, robot.col, {isFig1: true});
        var result = (figures.length > 0);
        context.callCallback(callback, result);
    };

    context.robot.onFigure2 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var figures = context.getItems(robot.row, robot.col, {isFig2: true});
        var result = (figures.length > 0);
        context.callCallback(callback, result);
    };

    context.robot.pickFigure1 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var robotType = infos.itemTypes[robot.type];
        var figures = context.getItems(robot.row, robot.col, {isFig1: true});
        if (robotType.isFig1) {
            throw(context.strings.messages.PickUpSelf);
        }
        if (figures.length == 0) {
            throw(context.strings.messages.noFigure1);
        }
        if (context.nbTransportedFigures > 0) {
            throw(context.strings.messages.alreadyTransportingFigure1);
        }
        var figure = figures[0];
        context.items.splice(figure.index, 1);
        context.nbTransportedFigures++;
        context.transportedFigure = figure;
        context.waitDelay(function () {
            if (context.display && figure.element != undefined) {
                figure.element.remove();
            }
            var allRobots = context.getItems(undefined, undefined, {category: "robot"});
            for (var iRobot = 0; iRobot < allRobots.length; iRobot++) {
                if (robot == allRobots[iRobot]) {
                    context.currentRobot = iRobot;
                }
            }
            callback();
        });
    ...
    context.robot.pickFigure2 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var figures = context.getItems(robot.row, robot.col, {isFig2: true});
        if (robot.type == "plesalec") {
            throw(context.strings.messages.PickUpSelf2)
        }
        if (figures.length == 0) {
            throw(context.strings.messages.noFigure2);
        }
        if (context.nbTransportedFigures > 0) {
            throw(context.strings.messages.alreadyTransportingFigure2);
        }
        var figure = figures[0];
        context.items.splice(figure.index, 1);
        context.nbTransportedFigures++;
    ...
    context.robot.dropFigure1 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        if (context.transportedFigure == undefined) {
            throw(context.strings.messages.notTransporting);
        }
        context.nbTransportedFigures = 0;
        context.waitDelay(function () {
            context.items.push(context.transportedFigure);
            context.transportedFigure.row = robot.row;
            context.transportedFigure.col = robot.col;
            context.transportedFigure.dir = robot.dir;
            if (context.display) {
                redisplayItem(context.transportedFigure);
            }
            var allRobots = context.getItems(undefined, undefined, {category: "robot"});
            for (var iRobot = 0; iRobot < allRobots.length; iRobot++) {
                if (robot == allRobots[iRobot]) {
            ...
            context.transportedFigure = undefined;
            callback();
        });
    };

    context.robot.dropFigure2 = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        if (context.transportedFigure == undefined) {
            throw(context.strings.messages.notTransporting);
        }
    ...
    context.robot.transportingFigure = function (callback) {
        var result = (context.nbTransportedFigures > 0);
        context.callCallback(callback, result);
    };

    context.robot.danceMove = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var items = context.getItems(robot.row, robot.col, {color: "red"});
        var robotType = infos.itemTypes[robot.type];
        if (items.length == 0) {
            context.lost = true;
            if (robotType.isFig1 == true) {
                throw("Plesalka" + strings.noRedCell);
            } else {
                throw("Plesalec" + strings.noRedCell);
            }
        }
        if (context.nbTransportedFigures > 0) {
            context.lost = true;
            if (robotType.isFig1) {
                throw(strings.ImpossibleToDance1 + " Plesalka" + strings.ImpossibleToDance2 + " plesalca.");
            } else {
                throw(strings.ImpossibleToDance1 + " Plesalec" + strings.ImpossibleToDance2 + " plesalko.");
            }

        }
        for (var iItem = 0; iItem < items.length; iItem++) {
            var curItem = items[iItem];
            context.nbDanceMoves++;
        }

        context.callCallback(callback);
    };

    context.robot.danceJump = function (callback) {
        var robot = context.getRobotItem(context.currentRobot);
        var items = context.getItems(robot.row, robot.col, {color: "blue"});
        var robotType = infos.itemTypes[robot.type];
        if (items.length == 0) {
            context.lost = true;
            if (robotType.isFig1) {
                throw("Plesalka" + strings.noBlueCell);
            } else {
                throw("Plesalec" + strings.noBlueCell);
            }
        ...
        if (context.nbTransportedFigures > 0) {
            context.lost = true;
            if (robotType.isFig1) {
                throw(strings.ImpossibleToDance1 + " Plesalka" + strings.ImpossibleToDanceJump2 + " plesalca.");
            } else {
                throw(strings.ImpossibleToDance1 + " Plesalec" + strings.ImpossibleToDanceJump2 + " plesalko.");
            }

        }
        for (var iItem = 0; iItem < items.length; iItem++) {
            var curItem = items[iItem];
            context.nbDanceJumps++;
        }
        context.callCallback(callback);
    };

    context.robot.redCell = function (callback) {
        robotCellIsColor(callback, "red");
    };

    context.robot.blueCell = function (callback) {
        robotCellIsColor(callback, "blue");
    };

    context.robot.orangeCell = function (callback) {
        robotCellIsColor(callback, "orange");
    };

    context.robot.yellowCell = function (callback) {
        robotCellIsColor(callback, "yellow");
    };

    context.robot.changeFigure1 = function (callback) {
        var allRobots = context.getItems(undefined, undefined, {category: "robot"});
        var robot = context.getRobotItem(context.currentRobot);
        var robotType = infos.itemTypes[robot.type];
        if (robotType.isFig2) {
            var index = 0;
            while (infos.itemTypes[allRobots[index].type].isFig2 && index < allRobots.length) {
                if (index + 1 == allRobots.length) {
                    index = 0;
                } else {
                    index++;
                }
            }
            context.currentRobot = index;
        } else {
            var index = 0;
            if (context.currentRobot + 1 < allRobots.length) {
                index = context.currentRobot + 1;
            }
            while (infos.itemTypes[allRobots[index].type].isFig2 && index < allRobots.length) {
                if (index + 1 == allRobots.length) {
                    index = 0;
    ...
    context.robot.changeFigure2 = function (callback) {
        var allRobots = context.getItems(undefined, undefined, {category: "robot"});
        var robot = context.getRobotItem(context.currentRobot);
        var robotType = infos.itemTypes[robot.type];
        var index = 0;
        if (robotType.isFig1) {
            while (infos.itemTypes[allRobots[index].type].isFig1 && index < allRobots.length) {
                if (index + 1 == allRobots.length) {
                    index = 0;
                } else {
                    index++;
    ...
    context.itemTypeAttributes = function(item) {
        return infos.itemTypes[item.type];
    };
    ...
    context.reset = function(gridInfos) {
        ...
        context.curRobot = 0;
        context.currentRobot = 0;
        context.nbTransportedItems = 0;
        context.nbTransportedFigures = 0;
        context.nbCollectedItems = 0;
        context.nbDanceMoves = 0;
        context.nbDanceJumps = 0;
        if (context.display) {
...
//      context.blocklyHelper.updateSize();
    ...
    context.customBlocks = {
        robot: {
            actions: [
                ...
                { name: "changeRobot",
                    blocklyJson: {
                        "message0": strings.changeRobotString,
                        "args0": [
                            {"type": "field_dropdown",
                                "name": "PARAM_0",
                                "options": [["plesalec", "plesalec"], ["plesalka", "plesalka"]]
                            }
                        ]
                    },
                },
            ...
            sensors: [
                ...
                { name: "redCell",            yieldsValue: true },
                { name: "blueCell",           yieldsValue: true },
                { name: "orangeCell",         yieldsValue: true },
                { name: "yellowCell",         yieldsValue: true },
                ...
                { name: "onFigure1",          yieldsValue: true },
                { name: "onFigure2",          yieldsValue: true },
                { name: "transportingFigure",   yieldsValue: true },
            ]
        },
        transport: {
            sensors: [
    ...
    var moveRobot = function(iRobot, newRow, newCol, newDir, callback) {
        // var iRobot = context.currentRobot;
...
var robotEndConditions = {
    ...
    checkDanceMoves : function(context, lastTurn) {
        var nbMoves = 0;
        var robot = context.getRobotItem(context.currentRobot);
        var paints = context.getItems(robot.row, robot.col, {color: "yellow"});
        for (var iRow = 0; iRow < context.tiles.length; iRow++) {
            var row = context.tiles[iRow];
            for (var iCol = 0; iCol < row.length; iCol++) {
                var items = context.getItems(iRow, iCol, {color: "red"});
                nbMoves += items.length;
            }
        }
        if (nbMoves == context.nbDanceMoves && paints.length != 0) {
            context.success = true;
            throw(window.languageStrings.messages.successDance);
        }
        if (nbMoves == context.nbDanceMoves) {
            context.success = false;
            throw(window.languageStrings.messages.failureReachGeenArea);
        }
        if (lastTurn) {
            context.success = false;
            throw(window.languageStrings.messages.failureDanceMoves);
        }
    },

    checkDanceMovesAndJumps : function(context, lastTurn) {
        var nbMoves = 0;
        var nbJumps = 0;
        var robot = context.getRobotItem(context.currentRobot);
        var paints = context.getItems(robot.row, robot.col, {color: "yellow"});
        for (var iRow = 0; iRow < context.tiles.length; iRow++) {
            var row = context.tiles[iRow];
            for (var iCol = 0; iCol < row.length; iCol++) {
                var itemsRed = context.getItems(iRow, iCol, {color: "red"});
                var itemsBlue = context.getItems(iRow, iCol, {color: "blue"});
                nbMoves += itemsRed.length;
                nbJumps += itemsBlue.length;
            }
        }
        if (nbMoves == context.nbDanceMoves && nbJumps == context.nbDanceJumps && paints.length != 0) {
            context.success = true;
            throw(window.languageStrings.messages.successDance);
        }
        if (nbMoves == context.nbDanceMoves && nbJumps == context.nbDanceJumps) {
            context.success = false;
            throw(window.languageStrings.messages.failureReachGeenArea);
        }
        if (lastTurn) {
            context.success = false;
            throw(window.languageStrings.messages.failureDanceJumps);
        }
    },

    checkFiguresReachYellowArea : function (context, lastTurn) {
        var figures = context.getItems(undefined, undefined, {category: "robot"});
        var robot = context.getRobotItem(context.currentRobot);
        var paints = context.getItems(robot.row, robot.col, {color: "yellow"});
        var endFigures = context.getItems(robot.row, robot.col, {category: "robot"});
        var reds = context.getItems(undefined, undefined, {color: "red"});
        var blues = context.getItems(undefined, undefined, {color: "blue"});
        var nbMoves = reds.length;
        var nbJumps = blues.length;

        if (nbMoves == context.nbDanceMoves && nbJumps == context.nbDanceJumps && paints.length != 0 && context.nbTransportedFigures == 0 && endFigures.length == figures.length) {
            context.success = true;
            throw(window.languageStrings.messages.successDance);
        } else {
            context.success = false;
            throw(window.languageStrings.messages.failureDance);
        }
        if (lastTurn) {
            context.success = false;
            throw(window.languageStrings.messages.failureDance);
    ...
    checkFiguresReachEndAreas : function (context, lastTurn) {
        var yellowPaint = context.getItems(undefined, undefined, {color: "yellow"});
        var endFigures = context.getItems(yellowPaint[0].row, yellowPaint[0].col, {category: "robot"});
        var orangePaints = context.getItems(undefined, undefined, {color: "orange"});
        var redPaints = context.getItems(undefined, undefined, {color: "red"});
        var bluePaints = context.getItems(undefined, undefined, {color: "blue"});
        var nbMoves = redPaints.length;
        var nbJumps = bluePaints.length;

        var solved = (endFigures.length > 0);

        if (solved) {
            var figureType = context.itemTypeAttributes(endFigures[0]);
            var isFig1Bool = figureType.isFig1;
            if (isFig1Bool) {
                var startFigures = context.getItems(undefined, undefined, {isFig1: true});
            } else {
                var startFigures = context.getItems(undefined, undefined, {isFig2: true});
            }
            solved = (nbMoves == context.nbDanceMoves && nbJumps == context.nbDanceJumps && context.nbTransportedFigures == 0 && endFigures.length == startFigures.length);
            for (var iPaint = 0; iPaint < orangePaints.length; iPaint++) {
                var thisPaint = orangePaints[iPaint];
                if (isFig1Bool) {
                    var figures = context.getItems(thisPaint.row, thisPaint.col, {isFig2: true});
                } else {
                    var figures = context.getItems(thisPaint.row, thisPaint.col, {isFig1: true});
                }
                if (figures.length != 1) {
                    solved = false;
                }
