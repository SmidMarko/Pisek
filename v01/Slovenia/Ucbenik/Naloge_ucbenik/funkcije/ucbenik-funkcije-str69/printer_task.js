function initTask(subTask) {
   subTask.gridInfos = {
      ...
      example: {
         easy: {
             blockly: '<xml id="solution3" style="display: none">\n' +
                 '  <block type="procedures_defreturn" id="10" x="10" y="10">\n' +
                 '    <mutation>\n' +
                 '      <arg name="a"></arg>\n' +
                 '    </mutation>\n' +
                 '    <field name="NAME">PrviDvakrat2</field>\n' +
                 '    <comment pinned="false" h="80" w="160">Opiši to funkcijo...</comment>\n' +
                 '    <statement name="STACK">\n' +
                 '      <block type="variables_set" id="11">\n' +
                 '        <field name="VAR">n</field>\n' +
                 ...
                 '                    <mutation value="1"></mutation>\n' +
                 '                    <value name="CONDITION">\n' +
                 '                      <block type="logic_operation" id="23">\n' +
                 '                        <field name="OP">AND</field>\n' +
                 '                        <value name="A">\n' +
                 '                          <block type="logic_compare" id="24" collapsed="true">\n' +
                 ...
                 '                            <field name="OP">EQ</field>\n' +
                 '                            <value name="A">\n' +
                 '                              <block type="lists_getIndex" id="28" collapsed="true">\n' +
                 '                                <mutation statement="false" at="true"></mutation>\n' +
                 '                                <field name="MODE">GET</field>\n' +
                 '                                <field name="WHERE">FROM_START</field>\n' +
                 '                                <value name="VALUE">\n' +
                 ...
                 '                    </value>\n' +
                 '                    <next>\n' +
                 '                      <block type="variables_set" id="33">\n' +
                 '                        <field name="VAR">prejsnji</field>\n' +
                 '                        <value name="VALUE">\n' +
                 '                          <block type="lists_getIndex" id="34" collapsed="true">\n' +
                 '                            <mutation statement="false" at="true"></mutation>\n' +
                 '                            <field name="MODE">GET</field>\n' +
                 '                            <field name="WHERE">FROM_START</field>\n' +
                 '                            <value name="VALUE">\n' +
                 ...
                 '    </value>\n' +
                 '  </block>\n' +
                 '  <block type="variables_set" id="38" x="10" y="270">\n' +
                 '    <field name="VAR">t</field>\n' +
                 '    <value name="VALUE">\n' +
                 '      <block type="lists_create_with" id="39" inline="true">\n' +
                 '        <mutation items="8"></mutation>\n' +
                 '        <value name="ADD0">\n' +
                 '          <block type="readInteger" id="40">\n' +
                 '          </block>\n' +
                 ...
                 '        </value>\n' +
                 '        <value name="ADD5">\n' +
                 '          <block type="readInteger" id="45">\n' +
                 '          </block>\n' +
                 '        </value>\n' +
                 '        <value name="ADD6">\n' +
                 '          <block type="readInteger" id="46">\n' +
                 '          </block>\n' +
                 '        </value>\n' +
                 '        <value name="ADD7">\n' +
                 '          <block type="readInteger" id="47">\n' +
                 '          </block>\n' +
                 '        </value>\n' +
                 '      </block>\n' +
                 '    </value>\n' +
                 '    <next>\n' +
                 '      <block type="print" id="48">\n' +
                 '        <value name="PARAM_0">\n' +
                 '          <block type="procedures_callreturn" id="50" inline="true">\n' +
                 '            <mutation name="PrviDvakrat2">\n' +
                 '              <arg name="a"></arg>\n' +
                 '            </mutation>\n' +
                 '            <value name="ARG0">\n' +
