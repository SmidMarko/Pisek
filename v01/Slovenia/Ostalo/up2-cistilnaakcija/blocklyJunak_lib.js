   ...
   var localLanguageStrings = {
      ...
      en: {
         label: {
            ...
            paintNorthEast: "paint above and to the right",
      ...
      sl: {
         ...
         messages: {
            ...
            alreadyTransporting: "Junak že nosi predmet.",
            notTransporting: "Junak skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
            successMarkersPainted: "Čestitamo, junak je pravilno pobarval polja!",
            failureMarkersPainted: "Junak ni pravilno pobarval polja.",
            successPickedAllCollectibles: "Čestitamo, junak je pobral vse smeti!",
            failurePickedAllCollectibles: "Junak ni pobral vseh smeti!",
            successReachGeenArea: "Čestitamo, junak je dosegel zeleno območje!",
            failureReachGeenArea: "Junak ni dosegel zelenega območja!",
            ...
            leavesGrid: "Junak je zapustil mrežo!"
         },
         description: {
