	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				//custom
				pickWithdrawable: "poberi odpadek",
				onWithdrawable: "na odpadku",
			...
			messages: {								//Besedila sporočil
				...
				//custom
				successPickedAllWithdrawables: "Čestitamo, pobral si vse smeti!",
				failurePickedAllWithdrawables: "Nisi pobral vseh smeti!",
