	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				pickWithdrawable: "poduhaj rožico",
				onWithdrawable: "na polju z rožico",
				withdrawableInFront: "smeti spredaj",
				...
				greenCell: "na polju je vtičnica",
			...
			code: {
				...
				withdrawableInFront: "smetiSpredaj",
			...
			description: {								//Opis ukazov
				...
				pickWithdrawable: "pojej deteljico",
				onWithdrawable: "na polju z deteljico",
				withdrawableInFront: "smeti spredaj",
				pickWithdrawableOptions: "daj pribor v %1 žep",
				onWithdrawableOptions: "na %1",
				onRoundObject: "na okroglem predmetu",
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Na tem polju ni rožice.",
				nothingToPickUp2: "Na tem polju ni rožice.",
				...
				successPickedAllWithdrawables: "Čestitamo! Čebelica je poduhala vse rožice!",
				failurePickedAllWithdrawables: "Ojoj! Čebelici ni uspelo poduhati vseh rožic. Poskusi še enkrat.",
				successReachGeenArea: "Super! Robotski sesalec je prispel do vtičnice.",
				failureReachGeenArea: "Ojoj! Robotski sesalec ni prispel do vtičnice. Poskusi še enkrat.",
				...
				jumpOutsideGrid: "Zajček skuša skočiti izven mreže!",
				jumpObstacleBlocking: "Zajček skuša skočiti, vendar zaradi ovire ne more!",
				jumpNoPlatform: "Zajček skuša skočiti, vendar ni nobene ploščadi!",
				downOutsideGrid: "Zajček se skuša premakniti izven mreže!",
				downNoPlatform: "Zajček se skuša premakniti dol, vendar spodaj ni ploščadi!",
				falls: "Zajček pada v prazno.",
				willFallAndCrash: "Zajček bo padel s ploščadi in se poškodoval!",
				obstacleOnCell: "Na tem polju je ovira.",
				platformOnCell: "Na tem polju je že ploščad.",
				obstacle: "Ojoj! Zajčel se je zaletel v oviro. Poskusi še enkrat.",
			},
		},
		none: {
			comment: {
...
//      context.blocklyHelper.updateSize();
   ...
   context.robot.onTransportable = function(callback) {
	...
	context.robot.withdrawableInFront = function(callback) {
      categoryInFront("withdrawable", false, callback);
   };
   ...
   context.customBlocks = {
      robot: {
         ...
         sensors: [
            ...
            { name: "withdrawableInFront",    yieldsValue: true },
