function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		cellSide: 60,							
		itemTypes: {
			green_robot: { img: "green_robot.png", category: "robot", side: 60, nbStates: 8, offsetX: 0, offsetY: 0, zOrder: 8},
			...
			nut: { num: 7, img: "object.png", side: 60, category: "withdrawable", isWithdrawable: true, zOrder: 5 },
