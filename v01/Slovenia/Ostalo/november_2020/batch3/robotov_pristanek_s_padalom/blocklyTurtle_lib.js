	...
	var localLanguageStrings = {
		...
		sl: {
			...
			messages: {						//Besedila sporočil
				paintingWrong: "Ojoj, robot ni narisal pravega vzorca. Poskusi še enkrat.",
				paintingCorrect: "Čestitamo, robot je pravilno narisal vzorec. Sedaj lahko skoči s padalom!",
				paintingFree: "Pišek je narisal vzorec, ki si ga sprogramiral. Če ga želiš shraniti, posnemi sliko zaslona.",
			},
		},
		none: {
			comment: {
