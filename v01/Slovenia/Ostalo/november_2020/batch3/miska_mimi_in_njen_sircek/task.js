function initTask(subTask) {
   ...
   subTask.gridInfos = {
      ...
      actionDelay: 200,
      itemTypes: {
		 green_robot: { img: "green_robot.png", category: "robot", side: 60, nbStates: 8, offsetX: 0, offsetY: 0 },
		 hole: { num: 2, img: "gnezdo5.png", side: 45, category: "hole", isObstacle: false, isHole: true, zOrder: 0, offsetX: 8, offsetY: 0 },
         marble: { num: 3, img: "hrana5.png", side: 30, category: "marble", isObstacle: false, isTransportable: true, zOrder: 1, offsetY: 0, offsetX: 15},
		 hole2: { num: 4, img: "gnezdo3.png", side: 45, category: "hole", isObstacle: false, isHole: true, zOrder: 0, offsetX: 8, offsetY: 0 },
         marble2: { num: 5, img: "hrana3.png", side: 30, category: "marble", isObstacle: false, isTransportable: true, zOrder: 1, offsetY: 0, offsetX: 15},
      },
      maxInstructions: 20,
      includeBlocks: {
