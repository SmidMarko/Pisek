   ...
   var localLanguageStrings = {
      ...
      sl: {
         ...
         messages: {
            ...
            alreadyTransporting: "Gosenica že nosi predmet.",
            notTransporting: "Miška Mimi skuša odložiti sirček, ampak ga ne nosi. Poskusi še enkrat.",
            successDroppedAllObjects: "Čestitamo, Gosenica je spustila vse predmete!",
            successMarkersPainted: "Čestitamo, Gosenica je pravilno postavila gnezda!",
            failureMarkersPainted: "Gosenica ni postavil gnezda na pravo polje.",
            successPickedAllCollectibles: "Čestitamo, Gosenica je pobrala vso hrano!",
            failurePickedAllCollectibles: "Gosenica ni pobrala hrane!",
            successReachGeenArea: "Čestitamo, Gosenica je dosegel zeleno območje!",
            failureReachGeenArea: "Gosenica ni dosegla zelenega območja!",
            successOneMarbleInHole: "Čestitamo, Mimi je sirček skrila v luknjico.",
            successAllMarblesInHoles: "Čestitamo, Mimi je sirček skrila v luknjico.",
            failureOneMarbleInHole: "Ojoj, sirček ni v luknjici. Poskusi še enkrat.",
            failureAllMarblesInHoles: "Ojoj, sirček ni v luknjici. Poskusi še enkrat.",
            leavesGrid: "Ojoj, miška Mimi je zapustila mrežo in se izgubila. Poskusi še enkrat."
         },
         description: {
            ...
            onTransportable: "naPredmetu(): Ali je Gosenica na predmetu, ki ga lahko pobere?",
            ...
            col: "stolpec(): Stolpec na katerem je Gosenica",
            row: "vrstica(): Vrstica na kateri je Gosenica",
         ...
         startingBlockName: "Program",
         exit_grid: "Gosenica je zapustila mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Gosenica že nosi predmet.",
         ...
         droppedAllItems: "Čestitamo, Pišek je spustil vse predmete!",
