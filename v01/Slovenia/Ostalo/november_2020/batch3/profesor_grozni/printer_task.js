	...
	subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		startingExample: { //vnaprej podana koda ukazov
			blockly: {
				...
				hard: '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="robot_start" id="Cvs?CMIVfi!###w}F3C)" deletable="false" movable="false" editable="false" x="0" y="0"></block><block type="controls_if" id="s;]Nqi2(_]yYhXr.gse8" x="2" y="80"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare" id="!;WGinpJx`+@oToY3`0c"><field name="OP">EQ</field><value name="B"><block type="math_number" id="2W=CRUAb#f?@`!+)Z`AK"><field name="NUM">1</field></block></value></block></value><statement name="DO0"><block type="variables_set" id="rj~f*pFCggJYqsC~J2uP"><field name="VAR">tip</field><value name="VALUE"><block type="text" id="9|L(eprQ}!]RCBXh;Kz5"><field name="TEXT">ustno</field></block></value></block></statement><statement name="ELSE"><block type="variables_set" id="EcNM/V|wV;?b=iF0MuZW"><field name="VAR">tip</field><value name="VALUE"><block type="text" id="khaz0SSv26mwB84-*P#f"><field name="TEXT">pisno</field></block></value></block></statement></block><block type="controls_if" id="}}T,or8liBxZ6OV[,OKM" x="1" y="216"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare" id="4Ou~Qv6t!;EhI?vvcsd2"><field name="OP">EQ</field><value name="B"><block type="math_number" id="vR@7C:!QNg.zJ{=etj(L"><field name="NUM">1</field></block></value></block></value><statement name="DO0"><block type="variables_set" id=",(hqiN8NtT,NszF8N@sN"><field name="VAR">pogled</field><value name="VALUE"><block type="text" id="2{Loe6(w}5e8XgetVrFH"><field name="TEXT">zelo grd</field></block></value></block></statement><statement name="ELSE"><block type="variables_set" id="Yulpic9bA{:jbcliL4JG"><field name="VAR">pogled</field><value name="VALUE"><block type="text" id="v{1:m+?RC59?bxh]H_T1"><field name="TEXT">manj grd</field></block></value></block></statement></block><block type="controls_if" id="`78=9W1O}fuu1yo8ROuz" x="3" y="359"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare" id="B5)iO#mDqW0{B3GvF;bn"><field name="OP">EQ</field><value name="B"><block type="math_number" id="KPg`.2uO7+T*K7yJK]uh"><field name="NUM">1</field></block></value></block></value><statement name="DO0"><block type="variables_set" id="SEr)V1n_[n:3,C`L`=*O"><field name="VAR">ocena</field><value name="VALUE"><block type="text" id="Ab3qi3lU_?nM7sSbkbY)"><field name="TEXT">1</field></block></value></block></statement><statement name="ELSE"><block type="controls_if" id="Kbg)le?V!5R|+PMuSlnG"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare" id="yh-tzF[oSK,:@WX26.oZ"><field name="OP">EQ</field><value name="B"><block type="math_number" id="-=PV{(iF{o6mAeeGG|-V"><field name="NUM">2</field></block></value></block></value><statement name="DO0"><block type="variables_set" id="_Q]KzCf][5;g@r)qvnV7"><field name="VAR">ocena</field><value name="VALUE"><block type="text" id="6a9nK{IVL6nYBYT2?laj"><field name="TEXT">2</field></block></value></block></statement><statement name="ELSE"><block type="controls_if" id="WBGzXCq5cq~#a~JSqiDF"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare" id="mn!e]vU-g++dB!pXypEp"><field name="OP">EQ</field><value name="B"><block type="math_number" id="iUeBP68AkuV=,G2NEau7"><field name="NUM">3</field></block></value></block></value><statement name="DO0"><block type="variables_set" id="`q:Ty]yUL4LmtCdQ?;eV"><field name="VAR">ocena</field><value name="VALUE"><block type="text" id="Mr2VxRq@)DYP9a_(PL-p"><field name="TEXT">3</field></block></value></block></statement><statement name="ELSE"><block type="variables_set" id="SBODHz8S9*z#D{+I:glS"><field name="VAR">ocena</field><value name="VALUE"><block type="text" id=";C3u+;.:Ew~I:r!7K+m;"><field name="TEXT">4</field></block></value></block></statement></block></statement></block></statement></block></xml>',
			},
		},		
