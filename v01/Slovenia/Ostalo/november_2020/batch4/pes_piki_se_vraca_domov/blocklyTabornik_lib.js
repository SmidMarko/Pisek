var getContext = function(display, infos, curLevel) {
    var localLanguageStrings = {
        ...
        sl: {
            label: {
                ...
                down: "pojdi dol",
                east: "pojdi proti vzhodu",
                south: "pojdi proti jugu",
                west: "pojdi proti zahodu",
                north: "pojdi proti severu",
                paint: "pusti sledi",
                ...
                obstacleInFront: "drevo spredaj",
                obstacleRight: "ovira desno",
                obstacleLeft: "ovira levo",
                obstacleEast: "drevo na vzhodu",
                obstacleWest: "drevo na zahodu",
                obstacleNorth: "drevo na severu",
                obstacleSouth: "drevo na jugu",
                paintInFront: "barva spredaj",
                paintOnCell: "barva tega polja",
                paintNorthWest: "barva zgoraj in levo",
                paintNorth: "sledi na severu",
                paintSouth: "sledi na jugu",
                paintWest: "sledi na zahodu",
                paintEast: "sledi na vzhodu",
            ...
            code: {
                ...
                paintSouth: "pobarvanaSpodaj",
                paintEast: "pobarvanaDesno",
                paintWest: "pobarvanaLevo",
            ...
            messages: {
                ...
                successReachGeenArea: "Čestitamo, Piki se je varno vrnil domov.",
                failureReachGeenArea: "Ojoj, Piki ni prišel domov. Poskusi še enkrat.",
                ...
                leavesGrid: "Ojoj, Piki se je zaletel v drevo. Poskusi še enkrat.",
    ...
    context.robot.paintEast = function (callback) {
        var robot = context.getRobotItem(context.curRobot);
        var items = context.getItems(robot.row, robot.col + 1, {isPaint: true});
        context.callCallback(callback, items.length > 0);
    };

    context.robot.paintWest = function (callback) {
        var robot = context.getRobotItem(context.curRobot);
        var items = context.getItems(robot.row, robot.col - 1, {isPaint: true});
        context.callCallback(callback, items.length > 0);
    };

    context.robot.paintSouth = function (callback) {
        var robot = context.getRobotItem(context.curRobot);
        var items = context.getItems(robot.row + 1, robot.col, {isPaint: true});
        context.callCallback(callback, items.length > 0);
    };
   ...
   context.customBlocks = {
      robot: {
         ...
         sensors: [
            ...
            { name: "paintSouth",         yieldsValue: true },
            { name: "paintEast",         yieldsValue: true },
            { name: "paintWest",         yieldsValue: true },
