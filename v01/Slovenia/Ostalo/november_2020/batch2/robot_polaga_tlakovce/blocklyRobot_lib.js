	...
	var localLanguageStrings = {
		...
		sl: {
			...
			messages: {								//Besedila sporočil
				...
				successMarkersPainted: "Čestitamo, robot je pravilno pobarval vse tlakovce.",
				failureMarkersPainted: "Ojoj, robot je pobarval napačno polje. Poskusi še enkrat.",
				...
				leavesGrid: "Robot je zapustil svoje dvorišče.",
