function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		cellSide: 60,							
		itemTypes: {
			green_robot: { img: "green_robot.png", category: "robot", side: 100, nbStates: 9, offsetY: 20, offsetX: -20, zOrder: 8},
		...
		medium: [
			{
				...
				initItems: [
					{ row: 4, col: 6, dir: 3, type: "green_robot" },
					...
					{ row: 4, col: 10, type: "marker" },
					{ row: 2, col: 7, type: "marker" },
					{ row: 2, col: 9, type: "marker" },
					{ row: 6, col: 7, type: "marker" },
					{ row: 6, col: 9, type: "marker" },
				],
			},
		],
	};
