	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				//custom
				pickWithdrawable: "poberi petico",
			...
			messages: {								//Besedila sporočil
				...
				//custom
				successPickedAllWithdrawables: "Čestitamo, Pišek je pobral vse petice!",
				failurePickedAllWithdrawables: "Pišek ni pobral vseh petic!",
				nothingToPickUp2: "Na polju ni petice.",
