	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				markedCell: "na polju je detelja",
			...
			messages: {								//Besedila sporočil
				...
				successMarkersPainted: "Čestitamo, zajček je pravilno odreagiral!",
				failureMarkersPainted: "Zajček ni pravilno odreagiral.",
