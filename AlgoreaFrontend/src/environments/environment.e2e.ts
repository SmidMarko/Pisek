...
export const environment: Environment = {
  production: false,
  apiUrl: 'http://localhost:8080', //'http://pisek-novi.acm.si:8080', //'http://localhost:8080', //'https://dev.algorea.org/api', // 'http://localhost:3000/api',
  oauthServerUrl: 'http://localhost:8282', //'http://pisek-novi.acm.si:8282' , //'http://localhost:8282',//'https://login.france-ioi.org', //TODO change
